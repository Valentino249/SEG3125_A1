            ...
            <div className="flex min-h-screen justify-center bg-orange-50 p-5 pt-10">
                ...
                <div>
                    ...
                    <div className="flex flex-col justify-center space-x-5">
                        <div className="flex">
                        <a className="mb-2 text-1xl font-bold text-blue-500" href="https://www.linkedin.com/in/valentino-vinod/" target="_blank" rel="noopener noreferrer">Linkedin&ensp;</a>
                        
                        <a className="mb-2 text-1xl font-bold text-red-400" href="https://gold249.itch.io/" target="_blank" rel="noopener noreferrer">Itch.io&ensp;</a>
